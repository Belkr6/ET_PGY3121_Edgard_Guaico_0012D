...
window.addEventListener('scroll', function() {
  ...
  const blurValue = Math.min(scrollTop / 50, 10); // ajusta el valor 50 y 10 para controlar la velocidad y la intensidad del difuminado
  document.getElementById("imagenindex").style.filter = `blur(${blurValue}px)`;
});
